...
function App() {
  return (
    <div>
    <h1 className='text-4xl font-bold mb-4 text-left padding-20px'>Smarter Tasks</h1>
    ...
    <div className='flex justify-around mb-4'>
      <div>
        <div className='border border-gray-300 p-6 rounded-2xl'>
          <h3 className='text-2xl mb-4 font-bold text-center'>Pending</h3>
      ...
      <div>
        <div className='border border-gray-300 p-6 rounded-2xl'>
          <h3 className='text-2xl mb-4 font-bold text-center'>Done</h3>
